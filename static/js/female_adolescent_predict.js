$(document).ready(function () {
    $("#predict-form").submit(function (e) {
        ...
        } else if (67 > repeatedJumps && repeatedJumps >= 36) {
            repeatedJumps_text = "🔵 당신의 반복점프 운동능력은 상위 그룹 25%에 속합니다.";
        } else if (36 > repeatedJumps && repeatedJumps >= 28) {
            repeatedJumps_text = "🟡 당신의 반복점프 운동능력은 평균보다 높습니다.";
        } else if (28 > repeatedJumps && repeatedJumps >= 21) {
        ...
        } else if (1.11 > hangTime && hangTime >= 0.464) {
            hangTime_text = "🔵 당신의 체공시간 굽히기 운동능력은 상위 그룹 25%에 속합니다.";
        } else if (0.464 > hangTime && hangTime >= 0.427) {
            hangTime_text = "🟡 당신의 체공시간 굽히기 운동능력은 평균보다 높습니다.";
        } else if (0.427 > hangTime && hangTime >= 0.39) {
  ...
  `;
        ...
        sit_and_reach = ((sit_and_reach / 38.5) * 100)
        ...
        repeatedJumps = ((repeatedJumps / 67) * 100)
        if (repeatedJumps > 100) {
            repeatedJumps = 100;
        }
        shuttleRun = ((shuttleRun / 59) * 100)
        if (shuttleRun > 100) {
            shuttleRun = 100;
        }
        standingLongJump = ((standingLongJump / 235) * 100)
        if (standingLongJump > 100) {
            standingLongJump = 100;
        }
        hangTime = ((hangTime / 1.11) * 100)
        if (hangTime > 100) {
            hangTime = 100;
        }
