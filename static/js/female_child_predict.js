$(document).ready(function () {
    $("#predict-form").submit(function (e) {
        ...
        if (isLocalhost) {
            // 로컬 호스트인 경우
            ajaxUrl = "http://127.0.0.1:8000/fitness_grade/female_child_predict_ajax/";
        } else {
            // 웹 서버인 경우
            ajaxUrl = "http://18.180.43.72/fitness_grade/female_child_predict_ajax/"; // 웹 서버의 실제 API 엔드포인트 URL로 대체해야 합니다.
        }
        ...
        } else if (43 > sit_and_reach && sit_and_reach >= 15.9) {
            sit_and_reach_text = "🔵 당신의 앉아윗몸앞으로 굽히기 운동능력은 상위 그룹 25%에 속합니다.";
        } else if (15.9 > sit_and_reach && sit_and_reach >= 10.6) {
            sit_and_reach_text = "🟡 당신의 앉아윗몸앞으로 굽히기 운동능력은 평균보다 높습니다.";
        } else if (10.6 > sit_and_reach && sit_and_reach >= 5) {
        ...
        } else if (92 > sit_ups && sit_ups >= 33) {
            sit_ups_text = "🔵 당신의 윗몸말아올리기 운동능력은 상위 그룹 25%에 속합니다.";
        } else if (33 > sit_ups && sit_ups >= 22) {
            sit_ups_text = "🟡 당신의 윗몸말아올리기 운동능력은 평균보다 높습니다.";
        } else if (22 > sit_ups && sit_ups >= 14) {
        ...
        } else if (131 > shuttleRun && shuttleRun >= 56) {
            shuttleRun_text = "🔵 당신의 왕복오래달리기 운동능력은 상위 그룹 25%에 속합니다.";
        } else if (56 > shuttleRun && shuttleRun >= 40) {
            shuttleRun_text = "🟡 당신의 왕복오래달리기 운동능력은 평균보다 높습니다.";
        } else if (40 > shuttleRun && shuttleRun >= 26) {
        ...
        } else if (230 > standingLongJump && standingLongJump >= 151) {
            standingLongJump_text = "🔵 당신의 제자리 멀리뛰기 운동능력은 상위 그룹 25%에 속합니다.";
        } else if (151 > standingLongJump && standingLongJump >= 135) {
            standingLongJump_text = "🟡 당신의 제자리 멀리뛰기 운동능력은 평균보다 높습니다.";
        } else if (135 > standingLongJump && standingLongJump >= 120) {
