$(document).ready(function () {
    $("#predict-form").submit(function (e) {
        ...
        if (isLocalhost) {
            // 로컬 호스트인 경우
            ajaxUrl = "http://127.0.0.1:8000/fitness_grade/female_senior_predict_ajax/";
        } else {
            // 웹 서버인 경우
            ajaxUrl = "http://18.180.43.72/fitness_grade/female_senior_predict_ajax/"; // 웹 서버의 실제 API 엔드포인트 URL로 대체해야 합니다.
        }
        ...
        if (chair_stand_test >= 38) {
            chair_stand_test_text = "🟢 당신의 의자에앉았다일어서기 운동능력은 최상등급에 속합니다.";
        } else if (38 > chair_stand_test && chair_stand_test >= 24) {
        ...
        if (grip_strength_left >= 34.1) {
            grip_strength_left_text = "🟢 당신의 왼쪽 악력 운동능력은 최상등급에 속합니다.";
        } else if (34.1 > grip_strength_left && grip_strength_left >= 23.9) {
            grip_strength_left_text = "🔵 당신의 왼쪽 악력 운동능력은 상위 그룹 25%에 속합니다.";
        } else if (23.9 > grip_strength_left && grip_strength_left >= 21.3) {
            grip_strength_left_text = "🟡 당신의 왼쪽 악력 운동능력은 평균보다 높습니다.";
        } else if (21.3 > grip_strength_left && grip_strength_left >= 18.5) {
        ...
        if (grip_strength_right >= 36.4) {
            grip_strength_right_text = "🟢 당신의 오른쪽 악력 운동능력은 최상등급에 속합니다.";
        } else if (36.4 > grip_strength_right && grip_strength_right >= 25.4) {
            grip_strength_right_text = "🔵 당신의 오른쪽 악력 운동능력은 상위 그룹 25%에 속합니다.";
        } else if (25.4 > grip_strength_right && grip_strength_right >= 22.5) {
            grip_strength_right_text = "🟡 당신의 오른쪽 악력 운동능력은 평균보다 높습니다.";
        } else if (22.5 > grip_strength_right && grip_strength_right >= 19.8) {
  ...
  `;
        ...
        sit_and_reach = ((sit_and_reach / 36.2) * 100)
        if (sit_and_reach > 100) {
            sit_and_reach = 100;
        } else if (sit_and_reach == 0) {
            sit_and_reach = 25;
        }
        chair_stand_test = ((chair_stand_test / 38) * 100)
        if (chair_stand_test > 100) {
            chair_stand_test = 100;
        }
        grip_strength_left = ((grip_strength_left / 34.1) * 100)
        if (grip_strength_left > 100) {
            grip_strength_left = 100;
        }
        two_minute_step_test = ((two_minute_step_test / 175) * 100)
        if (two_minute_step_test > 100) {
            two_minute_step_test = 100;
        }
        grip_strength_right = ((grip_strength_right / 36.4) * 100)
