...
urlpatterns = [
    ...
    path('board/detail/<int:postnum>/', views.board_detail, name='board_detail'),
    path('board/insert/', views.board_insert, name='board_insert'),
    path('board/update/<int:postnum>/', views.board_update, name='board_update'),
    path('board/delete/<int:postnum>/', views.board_delete, name='board_delete'),
    ...
    path('<int:postnum>/board_comment/', views.board_detail, name='board_detail'),
]
